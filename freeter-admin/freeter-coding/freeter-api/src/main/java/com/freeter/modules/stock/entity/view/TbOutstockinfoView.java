...
public class TbOutstockinfoView<T> implements Serializable {
	...
	private String outstockauditstate;
	...
	public String getOutstockauditstate() {
		return outstockauditstate;
	}
	public void setOutstockauditstate(String outstockauditstate) {
		this.outstockauditstate = outstockauditstate;
	}
	...
	private List<TbOutstockinfodetailView> list;
	
	
	public List<TbOutstockinfodetailView> getList() {
		return list;
	}
	public void setList(List<TbOutstockinfodetailView> list) {
		this.list = list;
	}
	/**
	 * 特殊出库原因
