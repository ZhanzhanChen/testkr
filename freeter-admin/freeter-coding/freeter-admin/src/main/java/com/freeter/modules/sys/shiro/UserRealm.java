...
public class UserRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(
		...
		user = sysUserDao.selectOne(user);
 		//账号不存在
		if(user == null) {
			//String s=redisUtils.getStr(token.getUsername()).toString();
//			if(redisUtils.hasKey(token.getUsername())){
//				int tmp =Integer.valueOf(redisUtils.getStr(token.getUsername()).toString());
//				redisUtils.setStr(token.getUsername(), String.valueOf(tmp+1));
//			}else{
//				redisUtils.setStr(token.getUsername(), String.valueOf(1));
//			}
